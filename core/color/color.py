...
def ReturnGreenNotify(string):
    return color.GREEN + color.BOLD + string + color.END


def ReturnArrowBlue(string):
    return color.BLUE + color.BOLD + '[->] ' + color.END + string
