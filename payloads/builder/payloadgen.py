...
class PayloadGenerator:
    ...
    @staticmethod
    def doPrintHelp():
        help = '''Usage: payloadgen [host] [port] [debug] [implantName] [output] [console] [persistence]
    ...
    Options:
        ...
        [persistence]   Make the implant persistence on first run.
        
    Example:
        payloadgen 127.0.0.1 9876 True Home stub.py False True
        '''
        return help
